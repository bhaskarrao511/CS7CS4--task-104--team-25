...
data = pd.read_excel(file, sheetname = 'bank-full')
...
target = range(100,data.shape[0],100)
...
for i in target:
    ...
    nl_acc.append(f1_score(data[:,-1], predictions_LR, average = average_method))
