...
data1 = data1.drop(["marital-status"], axis = 1)
#plt.scatter(data1.fnlwgt,data1.capital_loss)
...
for j in range(1, 5, 1):
   ...
   for i in range(1, 20, 1):
      ...
      #X_train, X_test, y_train, y_test = cross_validation.train_test_split(X_train1, y_train1, train_size=a)
